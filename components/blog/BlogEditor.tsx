...
import { 
  ...
  Save, Send, Trash2, Share2, Image as ImageIcon 
} from "lucide-react";
        ...
        {isPublishing && (
          <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/60 backdrop-blur-sm">
            <div className="bg-gray-900 rounded-lg p-8 shadow-xl border border-gray-800">
              ...
              <p className="text-white text-center">Publishing your blog...</p>
            </div>
          </div>
        )}
        ...
        {isSavingDraft && (
          <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/60 backdrop-blur-sm">
            <div className="bg-gray-900 rounded-lg p-8 shadow-xl border border-gray-800">
              ...
              <p className="text-white text-center">Saving your draft...</p>
            </div>
          </div>
        )}
          ...
          <div className="fixed inset-0 flex items-center justify-center z-40 bg-black/60 backdrop-blur-sm">
            <div className="w-full max-w-md p-6 bg-gray-900/90 rounded-xl border border-gray-700 shadow-2xl">
              <div className="flex justify-between items-center mb-5">
                <h3 className="text-xl font-bold text-white">Confirm Publish</h3>
                <button 
              ...
              <p className="text-gray-300 mb-6">Are you sure you want to publish this blog? Once published, it will be visible to readers.</p>
        ...
        {showConfirmDelete && (
          <div className="fixed inset-0 flex items-center justify-center z-40 bg-black/60 backdrop-blur-sm">
            <div className="w-full max-w-md p-6 bg-gray-900/90 rounded-xl border border-gray-700 shadow-2xl">
              ...
              <p className="text-gray-300 mb-6">Are you sure you want to delete this blog? This action cannot be undone and all content will be permanently lost.</p>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-40 bg-black/60 backdrop-blur-sm">
            <div className="w-full max-w-md p-6 bg-gray-900/90 rounded-xl border border-gray-700 shadow-2xl">
              ...
              >
                ...
                <p className="text-gray-500 text-sm">PNG, JPG, WebP (Max 10MB)</p>
              </div>
              ...
              <div className="p-6 lg:p-8">
                ...
                <div className="mb-6 pb-6 border-b border-gray-800">
                  {!preview ? (
                    ...
                    <>
                      <h1 className="text-2xl lg:text-3xl font-bold text-white mb-3">{title || "Untitled Blog"}</h1>
                      <p className="text-gray-300">{description || "No description provided"}</p>
                    </>
                  )}
                  
                  {/* Status indicator */}
                  {isAutosaving && !preview && (
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-800 flex flex-wrap gap-3 justify-between items-center">
                    <div className="flex gap-3">
                      ...
                      <button
                        ...
                        className="px-4 py-2 rounded-lg bg-gray-800 hover:bg-gray-700 text-white transition-colors flex items-center gap-2"
                      >
                        <Save size={16} />
                        Save Draft
                      </button>
